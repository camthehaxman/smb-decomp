...
/* 800AFCC4 000ABBE4  4B FD B6 11 */	bl ape_destroy
...
/* 800AFD34 000ABC54  90 0D 99 9C */	stw r0, submodeFinishFunc@sda21(r13)
...
/* 800AFDB0 000ABCD0  4B F6 8C 55 */	bl camera_set_state_all
...
/* 800AFE1C 000ABD3C  4B F7 30 F9 */	bl info_init_first
...
/* 800AFFA4 000ABEC4  80 0D 9D 00 */	lwz r0, debugFlags@sda21(r13)
...
/* 800B085C 000AC77C  4B F7 C2 01 */	bl SoundIcsReq
...
/* 800B0888 000AC7A8  4B F7 C1 D5 */	bl SoundIcsReq
...
/* 800B08BC 000AC7DC  4B F7 C1 A1 */	bl SoundIcsReq
lbl_800B08C0:
...
/* 800B0970 000AC890  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B09FC 000AC91C  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B0A40 000AC960  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B0A84 000AC9A4  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B0B80 000ACAA0  4B F6 7A C9 */	bl change_current_camera
/* 800B0B84 000ACAA4  4B FE 21 B9 */	bl u_draw_ball_shadow
/* 800B0B88 000ACAA8  4B FA 44 69 */	bl background_light_assign
/* 800B0B8C 000ACAAC  80 7C 00 2C */	lwz r3, 0x2c(r28)
/* 800B0B90 000ACAB0  4B F7 1A 31 */	bl reset_light_group
...
/* 800B0BA8 000ACAC8  4B FD BD 7D */	bl mot_ape_thread
lbl_800B0BAC:
/* 800B0BAC 000ACACC  80 6D 99 5C */	lwz r3, userWork@sda21(r13)
...
/* 800B0BD0 000ACAF0  80 6D 99 5C */	lwz r3, userWork@sda21(r13)
...
/* 800B0C28 000ACB48  4B FE 9D FD */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0C60 000ACB80  4B FE 9D C5 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0C98 000ACBB8  4B FE 9D 8D */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0CD0 000ACBF0  4B FE 9D 55 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0D08 000ACC28  4B FE 9D 1D */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0D40 000ACC60  4B FE 9C E5 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0D70 000ACC90  4B FE 9C B5 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0DA0 000ACCC0  4B FE 9C 85 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0DD0 000ACCF0  4B FE 9C 55 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0E00 000ACD20  4B FE 9C 25 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0E30 000ACD50  4B FE 9B F5 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0E60 000ACD80  4B FE 9B C5 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0E90 000ACDB0  4B FE 9B 95 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0F00 000ACE20  4B FE 9B 25 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B0F6C 000ACE8C  4B FE 9A B9 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1248 000AD168  4B FC 18 79 */	bl sprite_printf
...
/* 800B15C0 000AD4E0  4B FC 08 99 */	bl sprite_puts
...
/* 800B1624 000AD544  4B FC 05 55 */	bl sprite_putc
...
/* 800B1638 000AD558  4B FC 05 41 */	bl sprite_putc
lbl_800B163C:
...
/* 800B1674 000AD594  4B FE 93 B1 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B16B4 000AD5D4  4B FE 93 71 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B16F4 000AD614  4B FE 93 31 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1734 000AD654  4B FE 92 F1 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1774 000AD694  4B FE 92 B1 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B17B4 000AD6D4  4B FE 92 71 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B17F4 000AD714  4B FE 92 31 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1834 000AD754  4B FE 91 F1 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1874 000AD794  4B FE 91 B1 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B18B4 000AD7D4  4B FE 91 71 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B18EC 000AD80C  4B FE 91 39 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1924 000AD844  4B FE 91 01 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B195C 000AD87C  4B FE 90 C9 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B198C 000AD8AC  4B FE 90 99 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B19C4 000AD8E4  4B FE 90 61 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1A60 000AD980  4B FE 8F C5 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1ADC 000AD9FC  4B FE 8F 49 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1B50 000ADA70  4B FE 8E D5 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B1DAC 000ADCCC  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B1E3C 000ADD5C  4B FC 00 1D */	bl sprite_puts
lbl_800B1E40:
...
lbl_800B1E68:
/* 800B1E68 000ADD88  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B1F08 000ADE28  4B FC 0B B9 */	bl sprite_printf
...
/* 800B1F28 000ADE48  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
lbl_800B1FA4:
/* 800B1FA4 000ADEC4  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
lbl_800B2004:
/* 800B2004 000ADF24  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B2054 000ADF74  4B FC 0A 6D */	bl sprite_printf
...
lbl_800B2068:
/* 800B2068 000ADF88  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B25F0 000AE510  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
lbl_800B2670:
/* 800B2670 000AE590  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B2790 000AE6B0  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B2814 000AE734  4B FD 93 C1 */	bl new_ape_stat_motion
/* 800B2818 000AE738  48 00 01 F0 */	b lbl_800B2A08
lbl_800B281C:
/* 800B281C 000AE73C  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B2978 000AE898  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B2A04 000AE924  4B FD 91 D1 */	bl new_ape_stat_motion
lbl_800B2A08:
...
/* 800B2A18 000AE938  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B2AB8 000AE9D8  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
lbl_800B2B3C:
/* 800B2B3C 000AEA5C  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
lbl_800B2BC0:
/* 800B2BC0 000AEAE0  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B2C90 000AEBB0  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B2D30 000AEC50  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B2E00 000AED20  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B2EA4 000AEDC4  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B2F74 000AEE94  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B2FDC 000AEEFC  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B307C 000AEF9C  4B FB FA 45 */	bl sprite_printf
...
/* 800B3094 000AEFB4  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B310C 000AF02C  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B31E8 000AF108  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B333C 000AF25C  4B FB F7 85 */	bl sprite_printf
...
/* 800B336C 000AF28C  4B FB F7 55 */	bl sprite_printf
...
/* 800B33A8 000AF2C8  4B FB F7 19 */	bl sprite_printf
...
/* 800B33D8 000AF2F8  4B FB F6 E9 */	bl sprite_printf
...
/* 800B3A28 000AF948  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B3A80 000AF9A0  4B FE 6F A5 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B3B08 000AFA28  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B3B1C 000AFA3C  4B FE 6F 09 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B3C40 000AFB60  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B3C54 000AFB74  4B FE 6D D1 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B3FCC 000AFEEC  80 6D 99 5C */	lwz r3, userWork@sda21(r13)
...
/* 800B4038 000AFF58  4B FE 69 ED */	bl gxutil_load_pos_nrm_matrix
...
/* 800B4088 000AFFA8  80 6D 99 5C */	lwz r3, userWork@sda21(r13)
...
/* 800B40C4 000AFFE4  4B FE 69 61 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B40F8 000B0018  80 6D 99 5C */	lwz r3, userWork@sda21(r13)
...
/* 800B4134 000B0054  4B FE 68 F1 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B41D8 000B00F8  4B FE 68 4D */	bl gxutil_load_pos_nrm_matrix
...
/* 800B4254 000B0174  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B4278 000B0198  4B FE 67 AD */	bl gxutil_load_pos_nrm_matrix
...
/* 800B43F0 000B0310  80 6D 99 5C */	lwz r3, userWork@sda21(r13)
...
/* 800B445C 000B037C  4B FE 65 C9 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B44AC 000B03CC  80 6D 99 5C */	lwz r3, userWork@sda21(r13)
...
/* 800B44E8 000B0408  4B FE 65 3D */	bl gxutil_load_pos_nrm_matrix
...
/* 800B451C 000B043C  80 6D 99 5C */	lwz r3, userWork@sda21(r13)
...
/* 800B4558 000B0478  4B FE 64 CD */	bl gxutil_load_pos_nrm_matrix
...
/* 800B45FC 000B051C  4B FE 64 29 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B4678 000B0598  80 0D 99 54 */	lwz r0, globalAnimTimer@sda21(r13)
...
/* 800B469C 000B05BC  4B FE 63 89 */	bl gxutil_load_pos_nrm_matrix
...
/* 800B5748 000B1668  48 01 4C 91 */	bl MTXQuat
...
/* 800B59AC 000B18CC  48 01 4A 2D */	bl MTXQuat
...
/* 800B5CE0 000B1C00  4B FD 5E F5 */	bl new_ape_stat_motion
...
/* 800B5D38 000B1C58  4B FD 5E 9D */	bl new_ape_stat_motion
...
/* 800B5D4C 000B1C6C  80 6D 99 54 */	lwz r3, globalAnimTimer@sda21(r13)
...
/* 800B5DAC 000B1CCC  4B FD 5E 29 */	bl new_ape_stat_motion
...
/* 800B5DE8 000B1D08  4B FD 5D ED */	bl new_ape_stat_motion
lbl_800B5DEC:
/* 800B5DEC 000B1D0C  80 6D A0 74 */	lwz r3, lbl_802F2254@sda21(r13)
/* 800B5DF0 000B1D10  4B FD 66 B9 */	bl ape_skel_anim_main
...
/* 800B5EC4 000B1DE4  4B FD 65 45 */	bl mot_ape_set_quat_from_vec
lbl_800B5EC8:
